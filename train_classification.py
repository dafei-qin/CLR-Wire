...
from src.dataset.dataset_cls import SurfaceClassificationDataset as MyDataset
from src.trainer.trainer_classification import TrainerClassification as MyTrainer
from src.utils.config import NestedDictToClass, load_config
from src.dataset.dataset_fn import surface_scale_and_jitter, surface_rotate

program_parser = ArgumentParser(description='Train classification model.')
...
train_dataset = MyDataset(
    points_path=args.data.train_points_path,
    class_label_path=args.data.train_labels_path,
...
val_dataset = MyDataset(
    points_path=args.data.val_points_path,
    class_label_path=args.data.val_labels_path,
    is_train=False,
    res=args.model.res
)
