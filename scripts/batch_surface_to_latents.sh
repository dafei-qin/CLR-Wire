...
CHECKPOINT_PATH="checkpoints/train_1201_vae_1_canonical_var_l2norm_pred_closed/model-03.pt"
INPUT_BASE="../data/logan_jsons/abc"
OUTPUT_BASE="../data/logan_jsons_latent_pred_closed/abc"
CONFIG_PATH="src/configs/train_vae_v1_canonical_logvar_l2norm_pred_closed.yaml"
LOG_DIR="./logs/surface_to_latent"
...
for input_dir in "${DIRS[@]}"; do
    ...
    log_file="${LOG_DIR}/surface_to_latent_${log_name}.log"
