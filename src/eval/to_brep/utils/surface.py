    ...
    for face in faces_list:
        ...
        if 'uv' in face.keys():
            if len(face['uv']) > 0:
                ...
                # if len(face['uv'])==4:
                #     len_u,len_v=face['uv'][1]-face['uv'][0],face['uv'][3]-face['uv'][2]
                #     face['uv'][0]-=len_u*0.5
                #     face['uv'][1]+=len_u*0.5
                #     face['uv'][2]-=len_v*0.5
                #     face['uv'][3]+=len_v*0.5
        ...
        if surface_type == 'plane':
            ...
            continue
        if surface_type == 'plane' or surface_type == 'cylinder' or surface_type == 'cone' or surface_type == 'torus' or surface_type == 'sphere':
            len_u,len_v=face['uv'][1]-face['uv'][0],face['uv'][3]-face['uv'][2]
            #print("extend ",len_u,",",len_v)
            breplib.ExtendFace(occ_face,len_u*0.5,True,True,False,False,occ_face)
            breplib.ExtendFace(occ_face,len_v*0.5,False,False,True,True,occ_face)
        if plot:    
