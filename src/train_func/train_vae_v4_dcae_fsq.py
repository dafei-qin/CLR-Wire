"""
Training function for VAE v4: DC-AE + FSQ
For bspline surface patches (4x4x3)
"""
...
from src.trainer.trainer_vae_v4_dcae_fsq import Trainer_vae_v4_dcae_fsq
...
program_parser = ArgumentParser(description='Train vae_v4 DC-AE + FSQ model.')
...
model_name = getattr(args.model, 'name', 'DCAE_FSQ_VAE')
...
trainer = Trainer_vae_v4_dcae_fsq(
    model,
