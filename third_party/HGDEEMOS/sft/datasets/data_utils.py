...
def process_mesh(vertices, faces, quantization_bits=8, quan = True, augment=True, augment_dict=None):
...
def augment_mesh(vertices, scale_min=0.95, scale_max=1.05, rotation=1, jitter_strength=0.05):
